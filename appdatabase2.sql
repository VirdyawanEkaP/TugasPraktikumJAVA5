...
-- Membuang struktur basisdata untuk dbmahasiswa_2
CREATE DATABASE IF NOT EXISTS `dbmahasiswa_2` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `dbmahasiswa_2`;

-- membuang struktur untuk table dbmahasiswa_2.profile_mhs
